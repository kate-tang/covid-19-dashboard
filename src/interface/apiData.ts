...
// api path: https://covid-19.nchc.org.tw/api/covid19?CK=covid-19@nchc.org.tw&querydata=5002
interface CountyOrTown {
  id: string;
  a01: string;
  a02: string;
  a03: string;
...
export { Domestic, CountyOrTown, DailyLog, World, Country, Global }